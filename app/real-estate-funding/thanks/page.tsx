...
function RealEstateFundingThanksContent() {
  ...
  const partnerOptions =
    loanType === "hard-money"
      ? [partnerReferralDefinitions.nlc, partnerReferralDefinitions.rcn, partnerReferralDefinitions.kiavi]
      : [partnerReferralDefinitions.kiavi, partnerReferralDefinitions.nlc, partnerReferralDefinitions.rcn]
          ...
          <CardContent className="pt-8 pb-8 text-center">
            ...
            <div className="rounded-lg border border-cyan-500/20 bg-cyan-500/5 p-4 mb-6 text-left">
              <div className="mb-3 flex items-center gap-2 text-cyan-600">
                ...
                <p className="text-sm font-medium">Partner options tied to this submission</p>
              </div>
              <p className="mb-4 text-sm text-muted-foreground">
                If the deal is already well packaged, you can open a tracked partner path now. No Limit Capital is especially useful for investor buyers reviewing fix-and-flip, bridge, DSCR, or ground-up construction scenarios. VestBlock still keeps this request in review on our side.
              </p>
              <div className="space-y-3">
                {partnerOptions.map((partner, index) => (
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className={`flex items-start justify-between gap-3 rounded-lg border bg-background px-4 py-3 transition-colors ${
                      index === 0
                  ...
                  >
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">{partner.fitSummary}</p>
                    </div>
