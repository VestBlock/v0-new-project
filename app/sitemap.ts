...
const publicRoutes = [
  ...
  { path: '/next-move', priority: 0.98, changeFrequency: 'weekly' },
  { path: '/capital', priority: 0.96, changeFrequency: 'weekly' },
  { path: '/real-estate', priority: 0.96, changeFrequency: 'weekly' },
  { path: '/opportunity', priority: 0.96, changeFrequency: 'weekly' },
  ...
  { path: '/ai-assistant', priority: 0.86, changeFrequency: 'weekly' },
  { path: '/visibility-expansion', priority: 0.86, changeFrequency: 'weekly' },
  { path: '/visibility-expansion/case-study', priority: 0.78, changeFrequency: 'monthly' },
  { path: '/visibility-expansion/proof-hub', priority: 0.78, changeFrequency: 'monthly' },
  ...
  { path: '/deal-hunter', priority: 0.8, changeFrequency: 'weekly' },
