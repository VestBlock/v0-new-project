...
import { Users, FileText, CreditCard, TrendingUp, AlertCircle, Cog } from "lucide-react"
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            ...
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium">OpenAI Integration</CardTitle>
                <Cog className="h-4 w-4 text-muted-foreground" />
              </CardHeader>
              <CardContent>
                <div className="text-2xl font-bold">Diagnostic</div>
                <p className="text-xs text-muted-foreground">Check OpenAI API key status</p>
              </CardContent>
              <CardFooter>
                <Button asChild className="w-full">
                  <Link href="/admin/openai-diagnostic">Check API Key</Link>
                </Button>
              </CardFooter>
            </Card>
          </div>
