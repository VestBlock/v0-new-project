...
export default function CreditCardStrategyPage() {
  ...
  const startCheckout = async () => {
    ...
    try {
      const returnPath = `/funding/business-funding-strategy?requestId=${fundingRequest.id}`;
                ...
                <div className="space-y-3 rounded-md border p-4">
                  {[
                    [
                      ...
                      'I understand business credit funding applications may create hard inquiries and repayment obligations.',
                    ],
                    [
                      'consentNoGuarantee',
