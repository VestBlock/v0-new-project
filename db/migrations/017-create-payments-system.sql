...
-- Add column for PayPal transaction ID if it doesn't exist
DO $$
BEGIN
  IF NOT EXISTS(SELECT 1 FROM information_schema.columns WHERE table_name='payments' AND column_name='paypal_transaction_id') THEN
