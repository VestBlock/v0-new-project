-- Durable property intelligence and licensed-provider enrichment foundation.
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_property_intelligence_records_lead ON property_intelligence_records (existing_lead_id) WHERE existing_lead_id IS NOT NULL;
...
CREATE INDEX IF NOT EXISTS idx_provider_sync_logs_provider_created ON provider_sync_logs (provider_key, created_at DESC);
...
GRANT ALL ON property_intelligence_sources, property_intelligence_imports, owner_entities,
  property_intelligence_records, property_signals, parcel_geometries, owner_contact_candidates,
  osint_results, deal_scores, map_layers, buyer_match_results, enrichment_jobs,
  provider_sync_logs, outreach_preparation_records, property_intelligence_relationships TO service_role;

REVOKE ALL ON property_intelligence_sources, property_intelligence_imports, owner_entities,
  property_intelligence_records, property_signals, parcel_geometries, owner_contact_candidates,
  osint_results, deal_scores, map_layers, buyer_match_results, enrichment_jobs,
  provider_sync_logs, outreach_preparation_records, property_intelligence_relationships FROM anon, authenticated;
