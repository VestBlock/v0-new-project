...
const nlcProgramHighlights = [
  {
    title: "Fix and flip",
    detail: "$75k-$5M scenarios, 660+ credit minimum, up to 90% purchase leverage and up to 100% rehab funding on stronger experience tiers.",
  },
  {
    title: "Bridge",
    detail: "$75k-$3M short-term bridge and cash-out scenarios, 670+ credit minimum, up to 70% as-is LTV on qualifying files.",
  },
  {
    title: "Ground-up construction",
    detail: "$75k-$5M construction scenarios, 680+ credit minimum, up to 85% LTC and up to 75% ARV on experienced-builder files.",
  },
  {
    title: "DSCR rental",
    detail: "$75k-$2M rental-property scenarios, 670+ credit minimum, $100k minimum property value, purchase and refinance options reviewed by quote.",
  },
] as const

export function RealEstateFundingPage() {
  ...
  const handleLoanTypeCardKeyDown = (
  ...
  const handleEmailClick = () => {
    // Track direct contact intent from the funding page.
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const missingFieldMessage =
      loanType === "dscr"
        ? !creditScoreRange
          ? "Please select a credit range."
          : !entity
            ? "Please choose the borrower type."
            : !propertyType
        ...
        : !experienceLevel
          ...
          : !exitStrategy
            ? "Please select an exit strategy."
            : !closingTimeline
              ? "Please select a closing timeline."
              : !fundsNeeded
                ? "Please select the funds needed."
                : null

    if (missingFieldMessage) {
      toast({
        title: "Missing required information",
        description: missingFieldMessage,
        variant: "destructive"
      })
      return
    }
      ...
      <section className="pt-24 pb-12 px-4">
        <div className="container mx-auto text-center max-w-4xl">
          ...
          <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
            ...
            money, No Limit Capital partner review, or more preparation before
        ...
        <div className="container mx-auto max-w-5xl">
          <Card className="premium-card border-cyan-500/20">
            <CardHeader>
              ...
              <CardDescription>
                These options are best used when the property, reserves, timeline, and borrower details are already fairly organized. No Limit Capital gives VestBlock a stronger capital path for qualified investor buyers who need funding attached to real opportunities.
              </CardDescription>
            </CardHeader>
            <CardContent className="grid gap-4 md:grid-cols-3">
              <div className="rounded-xl border border-emerald-500/20 bg-emerald-500/5 p-5 transition-[transform,border-color] duration-200 hover:-translate-y-0.5 hover:border-emerald-300/40">
                <div className="mb-3 flex items-center gap-2">
                  <DollarSign className="h-5 w-5 text-emerald-400" />
                  <h3 className="text-lg font-semibold">{partnerReferralDefinitions.nlc.displayName}</h3>
                </div>
                <p className="mb-3 text-sm text-muted-foreground">
                  {partnerReferralDefinitions.nlc.fitSummary}
                </p>
                <p className="mb-4 text-sm text-muted-foreground">
                  {partnerReferralDefinitions.nlc.disclosure}
                </p>
                <Button asChild className="w-full bg-emerald-600 hover:bg-emerald-700">
                  <a
                    href={buildPartnerReferralPath({
                      ...
                      loanType: loanType || "investor-capital",
                      service: "real_estate_funding"
                    })}
                    target="_blank"
                    rel="noreferrer"
                  >
                    {partnerReferralDefinitions.nlc.ctaLabel}
      ...
      <section className="pb-8 px-4">
        <div className="container mx-auto max-w-5xl">
          <div className="mb-5 max-w-3xl">
            <h2 className="text-2xl font-semibold md:text-3xl">No Limit Capital program lanes</h2>
            <p className="mt-2 text-sm leading-6 text-muted-foreground">
              VestBlock can use these lanes to package a buyer or operator conversation faster. Program ranges are informational and subject to No Limit Capital underwriting, market restrictions, appraisal review, background review, borrower experience, credit, liquidity, and deal strength.
            </p>
          </div>
          <div className="grid gap-4 md:grid-cols-4">
            {nlcProgramHighlights.map((program) => (
              <div key={program.title} className="rounded-xl border border-white/10 bg-white/[0.035] p-4">
                <h3 className="font-semibold text-white">{program.title}</h3>
                <p className="mt-2 text-sm leading-6 text-muted-foreground">{program.detail}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="container mx-auto max-w-4xl">
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <Card
              ...
              onKeyDown={(event) => handleLoanTypeCardKeyDown(event, "dscr")}
              role="button"
              tabIndex={0}
            ...
            <Card
              ...
              onKeyDown={(event) => handleLoanTypeCardKeyDown(event, "hard-money")}
              role="button"
              tabIndex={0}
              aria-pressed={loanType === "hard-money"}
            >
              <CardContent className="pt-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Best for rehab, flip, bridge, or time-sensitive scenarios that may fit No Limit Capital or another deal-specific capital review.
                    </p>
                  </div>
                </div>
              </CardContent>
                  ...
                  <div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="grid md:grid-cols-2 gap-4">
                        ...
                        <div className="space-y-2">
                          <Label htmlFor="creditScoreRange">
                            Credit Range {loanType === 'hard-money' ? '(Optional)' : '*'}
                          </Label>
                      ...
                      <div className="grid md:grid-cols-2 gap-4">
                        ...
                        <div className="grid md:grid-cols-2 gap-4">
                          <div className="space-y-2">
                          <Label htmlFor="vestingOrEntityName">Borrower Name (LLC or personal)</Label>
                          <Input
                            id="vestingOrEntityName"
                            value={vestingOrEntityName}
                            onChange={(e) => setVestingOrEntityName(e.target.value)}
                            placeholder="Example: ABC Holdings LLC"
                          />
                        </div>
                        <div className="space-y-2">
