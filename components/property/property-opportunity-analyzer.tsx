...
export function PropertyOpportunityAnalyzer({ calculatorOnly = false }: { calculatorOnly?: boolean }) {
  ...
  }, [form.afterRepairValue, form.askingPrice, form.monthlyDebtService, form.monthlyInsurance, form.monthlyRentEstimate, form.monthlyTaxes, form.repairBudget, result])
