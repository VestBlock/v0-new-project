                ...
                <div className="space-y-6 p-5 md:p-10">
                  ...
                  <div className="space-y-3">
                    <h3 className="text-2xl font-semibold text-white md:text-4xl">
                      DealVault gives real estate operators a more credible way to track deal records.
                    </h3>
                    <p className="max-w-2xl text-sm leading-7 text-slate-300 md:text-base md:leading-8">
                      Use DealVault for assignment records, partner payouts, proof submissions, funding milestones, contractor checkpoints, and seller-to-buyer deal history while keeping private documents off-chain.
                    </p>
                  </div>
                  ...
                  <div className="grid gap-4 md:grid-cols-2">
                    <div className="rounded-2xl border border-white/10 bg-white/[0.04] p-5">
                      ...
                      <p className="mt-2 text-sm leading-6 text-slate-400">
                        Clean assignment history, payout tracking, and partner visibility without exposing raw deal files on-chain.
                      </p>
                    </div>
                    <div className="rounded-2xl border border-white/10 bg-white/[0.04] p-5">
                      <div className="mb-3 flex h-11 w-11 items-center justify-center rounded-full bg-cyan-500/10">
                      ...
                      <p className="mt-2 text-sm leading-6 text-slate-400">
                        Track seller intake, funding checkpoints, buyer movement, contractor milestones, and proof submissions with dashboard-ready activity and certificate output.
                      </p>
                    </div>
                  </div>
                </div>

                <div className="border-t border-white/10 bg-black/20 p-5 md:p-10 lg:border-l lg:border-t-0">
                  ...
                  <div className="mt-5 space-y-3">
                    ...
                    <Button variant="ghost" size="lg" asChild className="w-full justify-start px-0 text-slate-300 hover:bg-transparent hover:text-white">
                      <Link href="/real-estate-funding">Need buyer or lender routing instead?</Link>
                    </Button>
                  </div>
                </div>
              </div>
