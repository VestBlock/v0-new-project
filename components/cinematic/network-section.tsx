        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
            ...
            return (
              ...
              >
                <TiltCard className="rounded-2xl">
                  <Link
                    href={role.href}
                    className="group relative flex h-full flex-col overflow-hidden rounded-2xl border border-white/10 bg-white/[0.025] p-6 backdrop-blur-xl transition-[border-color] duration-300 hover:border-cyan-300/35 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-300"
                  >
          ...
          >
            <TiltCard className="rounded-2xl">
              <Link
                href="/get-started"
                className="group flex h-full flex-col justify-between rounded-2xl border border-cyan-300/25 bg-gradient-to-br from-cyan-400/15 to-amber-300/10 p-6 backdrop-blur-xl focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-300"
              >
