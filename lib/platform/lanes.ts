...
export const platformLanes: Record<PlatformLaneId, PlatformLane> = {
  capital: {
    ...
    primaryHref: '/next-move?focus=business-funding',
    routes: [
      { title: 'Business funding', body: 'Define the use of funds, business position, timing, and preparation gaps.', href: '/funding', access: 'Free eligibility review', boundary: 'Providers control underwriting, limits, pricing, and terms.' },
      { title: 'Real estate funding', body: 'Prepare a property-specific request for DSCR, bridge, rental, flip, or other deal review.', href: '/real-estate-funding', access: 'Free intake · review required', boundary: 'Funding remains subject to lender criteria and deal review.' },
      { title: 'Business acquisition capital', body: 'Organize acquisition criteria, diligence questions, capital needs, and readiness.', href: '/next-move?focus=business-acquisition', access: 'Free roadmap', boundary: 'No valuation, financing, or closing outcome is promised.' },
      { title: 'Business credit and readiness', body: 'Sequence entity, banking, records, credit, and selective application preparation.', href: '/tools/business-credit', access: 'Free account tool', boundary: 'No score, tradeline, approval, or funding guarantee.' },
      { title: 'Verified grants and programs', body: 'Explore potential programs and organize the information needed to verify fit.', href: '/tools/grants', access: 'Account tool', boundary: 'Eligibility, deadlines, and awards must be verified with each program.' },
      { title: 'Capital provider participation', body: 'Share lending coverage and criteria so appropriate requests can be reviewed.', href: '/lenders', access: 'Free provider profile', boundary: 'Each provider controls availability, compliance, pricing, and acceptance.' },
    ],
    sequence: [
