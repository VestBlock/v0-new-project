...
export const platformLanes: Record<PlatformLaneId, PlatformLane> = {
  ...
  'real-estate': {
    ...
    routes: [
      { title: 'Buyers', body: 'Use VestBlock’s current intake to define markets, asset types, price range, strategy, close capacity, and no-go criteria.', href: '/buyers', access: 'Next: share criteria · expanded controls later', boundary: 'No inventory, match, exclusivity, or closing is guaranteed.' },
      ...
      { title: 'Investors', body: 'VestBlock helps clarify an acquisition or portfolio objective and the information needed for a useful future review.', href: '/next-move?focus=real-estate-investing', access: 'Next: build a roadmap · profile controls later', boundary: 'No property, return, introduction, or transaction is guaranteed.' },
      { title: 'Agents', body: 'Use a VestBlock account to identify the market, client need, and professional role you may bring into the network.', href: '/join?next=%2Fworkspace&intent=real-estate-agent', access: 'Next: create an account · role workflow later', boundary: 'No referral, listing, client, fee, or transaction is guaranteed.' },
      { title: 'Wholesalers', body: 'Use a VestBlock account to preserve disposition coverage, property criteria, and future collaboration context.', href: '/join?next=%2Fworkspace&intent=wholesaler', access: 'Next: create an account · role workflow later', boundary: 'No buyer, assignment, fee, disposition, or closing is guaranteed.' },
      { title: 'Lenders', body: 'VestBlock records lending coverage and criteria through the existing provider profile for controlled operator review.', href: '/lenders', access: 'Next: share provider criteria · review required', boundary: 'Each provider controls availability, underwriting, pricing, and acceptance.' },
      { title: 'Builders', body: 'VestBlock’s current roadmap helps frame project stage, geography, scope, capacity, and support needs before a role workflow exists.', href: '/next-move?focus=builder', access: 'Next: frame the project · role workflow later', boundary: 'No project, contract, capital, or introduction is guaranteed.' },
      { title: 'Developers', body: 'VestBlock’s current roadmap helps clarify the site, project thesis, stage, capital context, and operating questions for future review.', href: '/next-move?focus=developer', access: 'Next: frame the project · role workflow later', boundary: 'No site, approval, capital, partner, or development outcome is guaranteed.' },
    ],
    sequence: [
