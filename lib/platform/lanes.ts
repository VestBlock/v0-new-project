...
export const platformLanes: Record<PlatformLaneId, PlatformLane> = {
  ...
  'real-estate': {
    ...
    routes: [
      { title: 'Buyers', body: 'Create a private, resumable profile for markets, asset types, economics, capacity, timing, and no-go criteria.', href: '/workspace/profiles/new?role=buyer', access: 'Account profile · operational now', boundary: 'Eligible profiles may be considered for reviewed matches only with matching permission. Outreach, exclusivity, and closing remain separate.' },
      { title: 'Sellers', body: 'VestBlock organizes a private, resumable case around condition, occupancy, timing, priorities, and voluntary price context.', href: '/sell', access: 'Next: start a private case · operational now', boundary: 'No offer, buyer, price, financing, closing date, or sale outcome is promised.' },
      { title: 'Investors', body: 'Organize an acquisition or portfolio thesis, economics, purchasing capacity, timing, and exclusions for VestBlock review.', href: '/workspace/profiles/new?role=investor', access: 'Account profile · operational now', boundary: 'No property, return, introduction, allocation, matching, or transaction is guaranteed.' },
      { title: 'Agents', body: 'Record market coverage, client focus, transaction coverage, referral preferences, and voluntary license context.', href: '/workspace/profiles/new?role=real_estate_agent', access: 'Account profile · operational now', boundary: 'No client, listing, referral, fee, or transaction is guaranteed.' },
      { title: 'Wholesalers', body: 'Define acquisition and disposition markets, property types, capacity, transaction preferences, and exclusions.', href: '/workspace/profiles/new?role=wholesaler', access: 'Account profile · operational now', boundary: 'No property, buyer, assignment, fee, disposition, or closing is guaranteed.' },
      { title: 'Lenders', body: 'Record provider-supplied coverage, products, underwriting context, capacity, documentation, and exclusions.', href: '/workspace/profiles/new?role=lender', access: 'Account profile · operational now', boundary: 'Rates, leverage, timing, and terms remain subject to provider verification, underwriting, availability, and change.' },
      { title: 'Builders', body: 'Describe markets, construction and project types, current capacity, project stage, needs, and voluntary credential context.', href: '/workspace/profiles/new?role=builder', access: 'Account profile · operational now', boundary: 'No project, contract, capital, referral, or introduction is guaranteed.' },
      { title: 'Developers', body: 'Organize markets, asset classes, site criteria, project stage, deal size, capital needs, and partner preferences.', href: '/workspace/profiles/new?role=developer', access: 'Account profile · operational now', boundary: 'No site, entitlement, approval, capital, partner, or development outcome is guaranteed.' },
    ],
    sequence: [
      { title: 'Choose your role', body: 'Buyer, seller, investor, agent, wholesaler, lender, builder, or developer.' },
...
export const platformScenarios: Array<{
  ...
  { id: 'participate', short: 'Participate', title: 'Offer capital, inventory, or services', lane: 'real-estate', href: '/workspace/profiles', action: 'Create a participant profile', access: 'Account profile · Private by default', vestblock: 'Captures what you provide, where you operate, who fits, and the permissions you control.', decision: 'Each participant controls availability, compliance, pricing, acceptance, and delivery.', needed: 'Role, coverage, criteria, capacity, contact owner, and voluntary credentials or disclosures.' },
]
