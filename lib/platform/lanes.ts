...
export const platformLanes: Record<PlatformLaneId, PlatformLane> = {
  ...
  'real-estate': {
    ...
    routes: [
      { title: 'Buyers', body: 'Create a private, resumable profile for markets, asset types, economics, capacity, timing, and no-go criteria.', href: '/workspace/profiles/new?role=buyer', access: 'Account profile · operational now', boundary: 'No sourcing, inventory, matching, outreach, exclusivity, or closing starts from this profile.' },
      ...
      { title: 'Investors', body: 'Organize an acquisition or portfolio thesis, economics, purchasing capacity, timing, and exclusions for operator review.', href: '/workspace/profiles/new?role=investor', access: 'Account profile · operational now', boundary: 'No property, return, introduction, allocation, matching, or transaction is guaranteed.' },
