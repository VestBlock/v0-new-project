...
const rows: DealMachineStrategyProvenance[] = [
  ...
  { key: 'portfolio-landlord', reviewOnly: true, candidateOnly: true, candidateReason: 'DealMachine verifies absentee ownership; repeated ownership evidence is required before treating this lead as a portfolio owner.', variant: 'multiple-investments', signals: ['absentee_owner'] },
  { key: 'small-multifamily-portfolio', reviewOnly: true, candidateOnly: true, candidateReason: 'DealMachine verifies a 2-20 unit property; repeated ownership evidence is required before treating the owner as a portfolio operator.', variant: 'two-to-twenty-units', signals: ['multifamily'] },
