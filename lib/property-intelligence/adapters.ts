...
export const futureProviderStubs: Record<ProviderAdapterKey, { label: string; status: 'implemented' | 'stub'; note: string }> = {
  ...
  attom: { label: 'ATTOM Property Data', status: 'implemented', note: 'Licensed equity, AVM, mortgage, owner, sale, assessment, and tax enrichment with caching and call budgets.' },
