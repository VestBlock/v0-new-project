...
export const capitalPathCatalog: Record<CapitalCaseType, CapitalPathDefinition> = {
  business_funding: {
    ...
    after: 'VestBlock saves the case, returns a readiness summary, and reviews submitted files before any provider handoff.',
  ...
  real_estate_funding: {
    ...
    after: 'The case enters VestBlock review. We may request missing information or identify an appropriate lender path; no deal is sent automatically.',
  ...
  business_acquisition: {
    ...
    after: 'VestBlock saves the case, identifies missing diligence, and routes the next action to a roadmap or team review.',
  ...
  business_credit: {
    ...
    after: 'The case remains in the customer workspace and can continue into the business-credit roadmap or VestBlock review when help is requested.',
  ...
  capital_provider: {
    ...
    vestblock: 'Creates an owned provider case, writes verified criteria into the lender network, and places the profile in VestBlock review before any opportunity routing.',
    ...
    after: 'VestBlock creates or updates the lender-network profile and a documented review record. Criteria remain private and no opportunity volume is promised.',
