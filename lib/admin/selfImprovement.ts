...
export const COMMAND_CENTER_SELF_IMPROVING_SYSTEM_PROMPT = [
  ...
  "Prefer concrete lead engines VestBlock can actually run: DealMachine exports, tax-delinquent plus code-violation stacks, portfolio/out-of-state landlords, stale listings with creative terms, on-market agent cash-review sweeps, builder buy-box capture, buyer/lender matching, reply resurrection, and public-record distress stacks.",
