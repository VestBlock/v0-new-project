...
export type StrategyDestination =
  ...
  | { mode: 'unresolved'; path: null; cta: null }
...
export const OPERATING_STRATEGY_DEFINITIONS = [
  {
    ...
    destination: { mode: 'public_route', path: '/capital', cta: 'Start your capital readiness review' },
    crmOwner: 'vestblock_crm',
  ...
  },
  {
    ...
    destination: { mode: 'public_route', path: '/workspace/profiles/new?role=lender', cta: 'Add your lending criteria' },
    crmOwner: 'vestblock_crm',
    automationOwner: 'vestblock_application',
    initialVersionStatus: 'draft',
    externalSendCap: 0,
  },
  {
    ...
    destination: { mode: 'public_route', path: '/next-move', cta: 'Build my free Next Move roadmap' },
    crmOwner: 'vestblock_crm',
    automationOwner: 'vestblock_application',
    initialVersionStatus: 'draft',
    externalSendCap: 0,
  },
  {
    ...
    destination: { mode: 'public_route', path: '/credit-upload', cta: 'Review my credit report and build an action plan' },
    crmOwner: 'vestblock_crm',
    automationOwner: 'vestblock_application',
    initialVersionStatus: 'draft',
    externalSendCap: 0,
  },
  {
    ...
    destination: { mode: 'public_route', path: '/next-move?focus=start-business', cta: 'Build my business readiness roadmap' },
    crmOwner: 'vestblock_crm',
    automationOwner: 'vestblock_application',
    initialVersionStatus: 'draft',
    externalSendCap: 0,
  ...
  },
  {
    ...
    destination: { mode: 'public_route', path: '/workspace/profiles', cta: 'Create your free participant profile' },
    crmOwner: 'vestblock_crm',
    automationOwner: 'vestblock_application',
    initialVersionStatus: 'draft',
    externalSendCap: 0,
